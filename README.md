...
Initially 4 old lead-acid car batteries were the "core" of my system and my modified 500 Watt MEANWELL power supply was my intelligent charger for this system. I monitored this system using GRAFANA and observed the balancing between the 4 batteries.
...
Since October 2023 I replaced my old lead-acid system by I nice DEYE RW-M6.1 battery. Usualy this battery is operated together with a DEYE inverter. But poor documentation for DEYE products and incompetence of these distributor from Berlin have an impact on my decision for VICTRON inverter.
...
The MultiPlus-II inverter can rudimentary monitor, charge and discharge the RW-M6.1 battery, but this battery will not detected correctly from the native CAN driver of "Venus OS".
